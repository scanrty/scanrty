  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-8 pt-32 pb-16">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center w-full">
        <div>
          <h1 className="text-6xl font-extrabold leading-tight mb-6 bg-gradient-to-r from-[#38bdf8] to-white bg-clip-text text-transparent">
          ...
          <div className="flex gap-6 flex-wrap">
            <a href="#pricing" className="px-8 py-4 rounded-full bg-gradient-to-br from-[#38bdf8] to-[#ffffff] text-white font-semibold no-underline shadow-lg shadow-[#38bdf8]/30 hover:shadow-[#38bdf8]/40 hover:-translate-y-0.5 transition-all text-lg">
