  ...
  return (
    <main>
      ...
      <section className="bg-[#001d3d] py-16">
        <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="text-center">
            <div className="text-6xl font-extrabold bg-gradient-to-br from-[#7dd3fc] to-[#ffffff] bg-clip-text text-transparent font-mono">24h</div>
            <div className="text-lg text-white mt-2">Délai de réponse maximum</div>
          </div>
          <div className="text-center">
            <div className="text-6xl font-extrabold bg-gradient-to-br from-[#7dd3fc] to-[#ffffff] bg-clip-text text-transparent font-mono">99%</div>
            <div className="text-lg text-white mt-2">Taux de détection</div>
          </div>
          <div className="text-center">
            <div className="text-6xl font-extrabold bg-gradient-to-br from-[#7dd3fc] to-[#ffffff] bg-clip-text text-transparent font-mono">500+</div>
            <div className="text-lg text-white mt-2">Biens surveillés</div>
          </div>
          <div className="text-center">
            <div className="text-6xl font-extrabold bg-gradient-to-br from-[#7dd3fc] to-[#ffffff] bg-clip-text text-transparent font-mono">24/7</div>
      ...
      <section className="max-w-7xl mx-auto px-8 py-32" id="problems">
        <h2 className="text-5xl font-extrabold text-center mb-4 bg-gradient-to-r from-[#7dd3fc] to-[#ffffff] bg-clip-text text-transparent">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="bg-[#001d3d] rounded-3xl p-12 border border-[#7dd3fc]/10 hover:border-[#7dd3fc] hover:-translate-y-2 transition-all hover:shadow-2xl hover:shadow-[#7dd3fc]/20">
            <img src="/images/problem1.svg" alt="Sous-location" className="w-full h-48 object-cover rounded-2xl mb-8" />
            <h3 className="text-3xl font-bold text-[#7dd3fc] mb-6">La sous-location illégale</h3>
            <ul className="space-y-4">
              <li className="text-white pl-8 relative before:content-['→'] before:absolute before:left-0 before:text-[#7dd3fc] before:font-bold">
          ...
          <div className="bg-[#001d3d] rounded-3xl p-12 border border-[#7dd3fc]/10 hover:border-[#7dd3fc] hover:-translate-y-2 transition-all hover:shadow-2xl hover:shadow-[#7dd3fc]/20">
            ...
            <h3 className="text-3xl font-bold text-[#7dd3fc] mb-6">La rentabilité hôtelière</h3>
            <ul className="space-y-4">
              <li className="text-white pl-8 relative before:content-['→'] before:absolute before:left-0 before:text-[#7dd3fc] before:font-bold">
      ...
      <section className="bg-[#001d3d] py-32" id="solutions">
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center mb-24">
            <div>
              <h3 className="text-4xl font-bold mb-6 bg-gradient-to-br from-[#7dd3fc] to-[#ffffff] bg-clip-text text-transparent">
              ...
              <div className="space-y-4 mb-8">
                <div className="bg-[#7dd3fc]/10 p-4 rounded-xl border-l-4 border-[#7dd3fc] font-medium text-white">
              ...
              <a href="#pricing" className="inline-block px-8 py-4 rounded-full bg-gradient-to-br from-[#7dd3fc] to-[#ffffff] text-white font-semibold no-underline shadow-lg shadow-[#7dd3fc]/30 hover:shadow-[#7dd3fc]/40 hover:-translate-y-0.5 transition-all">
                Protéger mon bien
              </a>
            </div>
            <div>
      ...
      <section className="max-w-7xl mx-auto px-8 py-32" id="pricing">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          {/* Sentinelle */}
          <div className="bg-[#001d3d] rounded-3xl p-12 border-2 border-[#7dd3fc]/10 hover:border-[#7dd3fc] hover:-translate-y-2 transition-all hover:shadow-2xl hover:shadow-[#7dd3fc]/30">
            <div className="text-center mb-8 pb-8 border-b border-[#7dd3fc]/20">
              <div className="text-sm text-white uppercase tracking-widest mb-2">Immobilier</div>
              <div className="text-3xl font-bold text-[#7dd3fc] mb-4">Sentinelle</div>
            ...
            <a href="mailto:info.client@scanrty.com?subject=Commande%20Sentinelle&body=Bonjour%2C%0A%0AJe%20souhaite%20commander%20l'offre%20Sentinelle%20(9%E2%82%AC)%20pour%20d%C3%A9tecter%20une%20%C3%A9ventuelle%20sous-location.%0A%0AAdresse%20du%20bien%20%C3%A0%20surveiller%20%3A%0A%0AMon%20nom%20%3A%0AMon%20t%C3%A9l%C3%A9phone%20%3A" className="block w-full px-8 py-4 text-center rounded-full bg-gradient-to-br from-[#7dd3fc] to-[#ffffff] text-white font-semibold no-underline shadow-lg shadow-[#7dd3fc]/30 hover:shadow-[#7dd3fc]/40 hover:-translate-y-0.5 transition-all">
              Commander
            </a>
          </div>

          {/* VigilAn */}
          <div className="bg-[#001d3d] rounded-3xl p-12 border-2 border-[#7dd3fc] hover:-translate-y-2 transition-all shadow-2xl shadow-[#7dd3fc]/30 relative md:scale-105">
            ...
            <div className="text-center mb-8 pb-8 border-b border-[#7dd3fc]/20">
              <div className="text-sm text-white uppercase tracking-widest mb-2">Immobilier</div>
              <div className="text-3xl font-bold text-[#7dd3fc] mb-4">VigilAn</div>
            ...
            <a href="mailto:info.client@scanrty.com?subject=Souscription%20VigilAn&body=Bonjour%2C%0A%0AJe%20souhaite%20souscrire%20%C3%A0%20l'offre%20VigilAn%20(59%E2%82%AC%2Fan)%20pour%20une%20surveillance%20annuelle.%0A%0AAdresse%20du%20bien%20%C3%A0%20surveiller%20%3A%0A%0AMon%20nom%20%3A%0AMon%20t%C3%A9l%C3%A9phone%20%3A" className="block w-full px-8 py-4 text-center rounded-full bg-gradient-to-br from-[#7dd3fc] to-[#ffffff] text-white font-semibold no-underline shadow-lg shadow-[#7dd3fc]/30 hover:shadow-[#7dd3fc]/40 hover:-translate-y-0.5 transition-all">
              Souscrire
            </a>
          </div>
          ...
          <div className="bg-[#001d3d] rounded-3xl p-12 border-2 border-[#7dd3fc]/10 hover:border-[#7dd3fc] hover:-translate-y-2 transition-all hover:shadow-2xl hover:shadow-[#7dd3fc]/30">
            <div className="text-center mb-8 pb-8 border-b border-[#7dd3fc]/20">
              ...
              <div className="text-3xl font-bold text-[#7dd3fc] mb-4">TarGate</div>
          ...
          <div className="bg-[#001d3d] rounded-3xl p-12 border-2 border-[#7dd3fc]/10 hover:border-[#7dd3fc] hover:-translate-y-2 transition-all hover:shadow-2xl hover:shadow-[#7dd3fc]/30">
            <div className="text-center mb-8 pb-8 border-b border-[#7dd3fc]/20">
              <div className="text-sm text-white uppercase tracking-widest mb-2">Hôtellerie</div>
              <div className="text-3xl font-bold text-[#7dd3fc] mb-4">HitScan</div>
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-br from-[#7dd3fc] to-[#ffffff] py-24 text-center my-32">
        ...
        <a href="#pricing" className="inline-block px-12 py-5 rounded-full bg-white text-[#5eb3e4] font-bold text-xl no-underline hover:bg-[#000814] hover:text-[#7dd3fc] transition-all shadow-2xl">
          Commencer maintenant
        </a>
      </section>

      {/* Footer */}
      <footer className="bg-[#001d3d] py-16 border-t border-[#7dd3fc]/10" id="contact">
        <div className="max-w-7xl mx-auto px-8">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div className="md:col-span-2">
              <h3 className="text-2xl font-bold text-[#7dd3fc] mb-4">ScanRty</h3>
            ...
            <div>
              <h4 className="text-xl font-bold text-[#7dd3fc] mb-4">Solutions</h4>
              <ul className="space-y-2">
                <li><a href="#solutions" className="text-white hover:text-[#7dd3fc] transition-colors no-underline">Détection sous-location</a></li>
                <li><a href="#solutions" className="text-white hover:text-[#7dd3fc] transition-colors no-underline">Optimisation hôtelière</a></li>
                <li><a href="#pricing" className="text-white hover:text-[#7dd3fc] transition-colors no-underline">Tarifs</a></li>
              </ul>
            </div>
            <div>
              <h4 className="text-xl font-bold text-[#7dd3fc] mb-4">Contact</h4>
              <ul className="space-y-2">
                <li><a href="mailto:info.client@scanrty.com" className="text-white hover:text-[#7dd3fc] transition-colors no-underline">info.client@scanrty.com</a></li>
                <li className="text-white">60 rue François 1er</li>
                <li className="text-white">75008 PARIS</li>
              </ul>
            </div>
          </div>
          <div className="text-center pt-8 border-t border-[#7dd3fc]/10 text-white">
