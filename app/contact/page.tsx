          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-center pt-4">
              <button
                ...
                className="px-12 py-4 rounded-full bg-gradient-to-br from-[#38bdf8] to-[#ffffff] text-white font-bold text-lg shadow-lg shadow-[#38bdf8]/30 hover:shadow-[#38bdf8]/40 hover:-translate-y-0.5 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
